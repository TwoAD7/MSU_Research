...
def main():
	...
	if res == "yes":
		bool_val,FP_slit_width,isotope_start,wedge_range=a4l.start()
	else:
		bool_val,FP_slit_width,isotope_start,wedge_range=a4l.start2()
	#a4l.show_pixels()
	...
	a4l.isotope_tuning_values(bool_val,FP_slit_width,isotope_start,wedge_range)
